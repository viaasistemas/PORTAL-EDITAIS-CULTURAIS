...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      {/* Hero Section */}
      <section className="relative pt-12 md:pt-16 pb-12 overflow-hidden min-h-[55vh] flex items-start justify-center bg-slate-50/30">
        {/* Background Image */}
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-5xl -mt-8 md:-mt-12">
