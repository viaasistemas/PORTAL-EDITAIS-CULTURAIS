...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      {/* Hero Section */}
      <section className="relative pt-24 md:pt-40 pb-20 overflow-hidden min-h-[85vh] flex items-start justify-center bg-slate-50/30">
        {/* Background Image */}
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-5xl mt-12 md:mt-20">
