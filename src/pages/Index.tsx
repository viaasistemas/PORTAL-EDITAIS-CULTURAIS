        ...
        <div className="container mx-auto px-4 relative z-20 max-w-7xl w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 text-left flex flex-col justify-center z-10">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 tracking-tight leading-[1.15] text-[#3c64c1] text-left">
                Transforme<br />
                sua ideia em<br />
                <span className="text-5xl md:text-6xl lg:text-7xl text-[#f9b233] italic block mt-2">Realidade</span>
              </h1>
              <p className="text-slate-700 mb-8 text-base md:text-lg font-semibold leading-relaxed max-w-xl text-left">
