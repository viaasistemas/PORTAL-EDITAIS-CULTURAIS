...
import { Plus, FileEdit, Trash2, ExternalLink, Image as ImageIcon } from 'lucide-react';
      ...
      <main className="flex-grow flex flex-col">
        ...
        <div className="p-8 max-w-7xl mx-auto w-full space-y-10">
          <div className="flex justify-between items-center">
            ...
            <Button className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-6 font-bold flex gap-2 shadow-lg shadow-blue-100">
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <button className="p-4 rounded-2xl border border-slate-100 hover:border-blue-200 hover:bg-blue-50/30 transition-all text-left group">
