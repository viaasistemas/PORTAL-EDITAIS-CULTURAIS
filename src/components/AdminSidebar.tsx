    ...
    >
        ...
        <div className="flex items-center gap-3">
          ...
          {!isCompact && (
            <div className="overflow-hidden">
              <h2 className="text-lg font-bold text-slate-900 leading-none truncate">Cultura</h2>
      ...
      <nav className="flex flex-col gap-3 px-4 flex-grow">
        ...
        <div className="mt-4 pt-4 border-t border-slate-100">
          <Link 
            ...
            onClick={handleItemClick}
            className={`flex items-center gap-4 p-4 rounded-2xl transition-all text-slate-400 hover:bg-slate-50 hover:text-blue-600 ${
      ...
      <div className="px-4 mt-auto">
        <button 
          ...
          className={`w-full flex items-center gap-4 p-4 rounded-2xl text-slate-400 hover:text-red-500 hover:bg-red-50 transition-all group ${isCompact ? 'justify-center px-0' : ''}`}
        >
